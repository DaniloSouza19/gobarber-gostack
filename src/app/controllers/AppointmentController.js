...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    /**
     * Check if provider_id is different from the userId
     */
  ...
  async delete(req, res) {
    ...
    /**
     * Check if appointment user is userId
     */
    ...
    /**
     * Check date is valid to cancel appointment
     */
    ...
    if (isBefore(dateWithSub, new Date())) {
      return res.json({
        error: 'You can only cancel appointmnets 2 hours in advance.',
      });
    }
